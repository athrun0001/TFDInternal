...
const char* NoSpreadSig = "\x48\x8B\x86\xD0\x00\x00\x00\xF3\x0F\x11\xBE";
const char* NoSpreadMask = "xxxxxxxxxxx";
...
const char* NoRecoilSig = "\x84\xC0\x74\x1F\x48\x8B\xBE\xF0\x00\x00\x00\x8B\x9E";
const char* NoRecoilMask = "xxxxxxxxxxxxx";
uint8_t* NoRecoilAddress = 0;
//const char* RapidFireSig = "\x72\x00\xF3\x0F\x10\x87\x00\x00\x00\x00\x48";
// char* RapidFireMask = "x?xxxx????x";
const char* RapidFireSig = "\x72\x30\xF3\x0F\x10\x87\x3C\x01\x00\x00\x48\x8B\xCF";
const char* RapidFireMask = "xxxxxxxxxxxxx";
