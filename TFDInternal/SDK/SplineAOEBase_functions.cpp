...
void ASplineAOEBase_C::InvokePeriodStatusEffect(class AActor* Target)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SplineAOEBase_C", "InvokePeriodStatusEffect");

	Params::SplineAOEBase_C_InvokePeriodStatusEffect Parms{};
...
bool ASplineAOEBase_C::HasPeriod()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SplineAOEBase_C", "HasPeriod");

	Params::SplineAOEBase_C_HasPeriod Parms{};
